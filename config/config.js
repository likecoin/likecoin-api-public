...
config.LIKER_NFT_MINT_MIN_BATCH = 7; // limit for USD base
config.LIKER_NFT_LIKE_TO_USD_CONVERT_RATIO = 1024;
config.LIKER_NFT_MIN_USD_PRICE = 1;
config.LIKER_NFT_GAS_FEE = '200000';
config.LIKER_NFT_TX_FEE_DISCOUNT_IN_USD = 0.5;
config.LIKER_NFT_LIKE_PRICE_DISCOUNT_RATIO = 0.05;
