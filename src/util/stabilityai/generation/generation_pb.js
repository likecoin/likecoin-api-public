...
goog.exportSymbol('proto.gooseai.TransformBlend', null, global);
 ...
 * @constructor
 */
proto.gooseai.TransformBlend = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.TransformBlend, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.TransformBlend.displayName = 'proto.gooseai.TransformBlend';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.gooseai.TransformBlend.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.TransformBlend.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.TransformBlend} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.TransformBlend.toObject = function(includeInstance, msg) {
  var f, obj = {
    amount: jspb.Message.getFloatingPointFieldWithDefault(msg, 1, 0.0),
    target: (f = msg.getTarget()) && proto.gooseai.Artifact.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.TransformBlend}
 */
proto.gooseai.TransformBlend.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.TransformBlend;
  return proto.gooseai.TransformBlend.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.TransformBlend} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.TransformBlend}
 */
proto.gooseai.TransformBlend.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.TransformBlend.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.TransformBlend.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.TransformBlend} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.TransformBlend.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAmount();
  if (f !== 0.0) {
    writer.writeFloat(
 ...
 * @return {number}
 */
proto.gooseai.TransformBlend.prototype.getAmount = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 1, 0.0));
};
...
/**
 * @param {number} value
 * @return {!proto.gooseai.TransformBlend} returns this
 */
proto.gooseai.TransformBlend.prototype.setAmount = function(value) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};


/**
 * optional Artifact target = 2;
 * @return {?proto.gooseai.Artifact}
 */
proto.gooseai.TransformBlend.prototype.getTarget = function() {
  return /** @type{?proto.gooseai.Artifact} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.Artifact, 2));
};
 ...
 * @return {!proto.gooseai.TransformBlend} returns this
*/
proto.gooseai.TransformBlend.prototype.setTarget = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.gooseai.TransformBlend} returns this
 */
proto.gooseai.TransformBlend.prototype.clearTarget = function() {
 ...
 * @return {boolean}
 */
proto.gooseai.TransformBlend.prototype.hasTarget = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.gooseai.TransformColorMatch.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    image: (f = msg.getImage()) && proto.gooseai.Artifact.toObject(includeInstance, f)
  };
 ...
 * @const
 */
proto.gooseai.TransformParameters.oneofGroups_ = [[1,2,3,4,5]];
...
proto.gooseai.TransformParameters.toObject = function(includeInstance, msg) {
  var f, obj = {
    blend: (f = msg.getBlend()) && proto.gooseai.TransformBlend.toObject(includeInstance, f),
...
proto.gooseai.TransformParameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.gooseai.TransformBlend;
      reader.readMessage(value,proto.gooseai.TransformBlend.deserializeBinaryFromReader);
      msg.setBlend(value);
      break;
    case 2:
...
/**
 * optional TransformBlend blend = 1;
 * @return {?proto.gooseai.TransformBlend}
 */
proto.gooseai.TransformParameters.prototype.getBlend = function() {
  return /** @type{?proto.gooseai.TransformBlend} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.TransformBlend, 1));
};


/**
 * @param {?proto.gooseai.TransformBlend|undefined} value
 * @return {!proto.gooseai.TransformParameters} returns this
*/
proto.gooseai.TransformParameters.prototype.setBlend = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.gooseai.TransformParameters.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gooseai.TransformParameters} returns this
 */
proto.gooseai.TransformParameters.prototype.clearBlend = function() {
 ...
 * @return {boolean}
 */
proto.gooseai.TransformParameters.prototype.hasBlend = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
/**
 * optional TransformColorMatch color_match = 3;
 * @return {?proto.gooseai.TransformColorMatch}
 */
proto.gooseai.TransformParameters.prototype.getColorMatch = function() {
  return /** @type{?proto.gooseai.TransformColorMatch} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.TransformColorMatch, 3));
};
 ...
 * @return {!proto.gooseai.TransformParameters} returns this
*/
proto.gooseai.TransformParameters.prototype.setColorMatch = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.gooseai.TransformParameters.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gooseai.TransformParameters} returns this
 */
proto.gooseai.TransformParameters.prototype.clearColorMatch = function() {
 ...
 * @return {boolean}
 */
proto.gooseai.TransformParameters.prototype.hasColorMatch = function() {
  return jspb.Message.getField(this, 3) != null;
};
