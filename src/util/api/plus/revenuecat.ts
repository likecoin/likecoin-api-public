    ...
    const acquisitionEventPayload = {
      ...
      extraProperties: {
        ...
        ...mapAttributionExtraProperties({
          ...
          initialUtmSource: getSubscriberAttribute(event, 'initialUtmSource'),
          initialUtmMedium: getSubscriberAttribute(event, 'initialUtmMedium'),
          initialUtmCampaign: getSubscriberAttribute(event, 'initialUtmCampaign'),
