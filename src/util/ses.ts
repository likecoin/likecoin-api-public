      ...
      Body: {
        Html: {
          ...
          Data: getBasicV2Template({
            ...
            <p>2. 在<a href="${claimPageURLZh}">認領頁面</a>，連結錢包以驗證領取 NFT 正版證明資格。</p>
            ...
            <p>2. Visit the <a href="${claimPageURLEn}">claim page</a>${mustClaimToView ? '' : ' again'}, connect your wallet to claim the NFT for proof of ownership.</p>
