...
// Exported for tests to spy on sendEmail and snapshot the built params.
export const ses = new SES(TEST_MODE ? {} : {
...
// BCC sales on real sends only; TEST_MODE sends skip the BCC entirely.
const SALES_BCC = TEST_MODE ? undefined : [SALES_EMAIL];

// Shared SES send envelope. `replyTo: []` omits ReplyToAddresses; omitting `to`
...
function sendSESTemplateEmail({
  ...
  cc,
  bcc,
  replyTo = [CUSTOMER_SERVICE_EMAIL],
  title,
  html,
}: {
  functionName: string;
...
export function sendNFTBookListingEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookListingEmail',
    to: [SALES_EMAIL],
    title,
    html: getBasicV2Template({
      title,
...
export function sendNFTBookPendingClaimEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookPendingClaimEmail',
    to: [email],
    bcc: SALES_BCC,
    title,
    html,
...
export function sendNFTBookCartPendingClaimEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookCartPendingClaimEmail',
    to: [SALES_EMAIL], // send to SALES_EMAIL instead of email before revamp
    title,
    html,
  });
}
...
export function sendNFTBookGiftPendingClaimEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookGiftPendingClaimEmail',
    to: [toEmail],
    bcc: SALES_BCC,
    title,
    html,
...
export function sendNFTBookCartGiftPendingClaimEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookCartGiftPendingClaimEmail',
    to: [toEmail],
    bcc: SALES_BCC,
    title,
    html,
...
export function sendNFTBookGiftClaimedEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookGiftClaimedEmail',
    to: [fromEmail],
    bcc: SALES_BCC,
    title,
    html,
...
export function sendNFTBookGiftSentEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookGiftSentEmail',
    to: [fromEmail],
    bcc: SALES_BCC,
    title,
    html,
...
export function sendNFTBookManualDeliverSentEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookManualDeliverSentEmail',
    to: [email],
    bcc: SALES_BCC,
    title,
    html,
...
export function sendNFTBookSalePaymentsEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookSalePaymentsEmail',
    to: [email],
    bcc: SALES_BCC,
    title,
    html: getBasicV2Template({
...
export function sendNFTBookOutOfStockEmail({
  ...
  <p>3ook.com 書店</p>`;
  return sendSESTemplateEmail({
    functionName: 'sendNFTBookOutOfStockEmail',
    replyTo: [],
    to: [email],
    bcc: SALES_BCC,
    title,
...
export function sendPlusBookPromoCodeEmail({
  ...
  return sendSESTemplateEmail({
    functionName: 'sendPlusBookPromoCodeEmail',
    to: [email],
    bcc: SALES_BCC,
    title: subjectTitle,
    html,
