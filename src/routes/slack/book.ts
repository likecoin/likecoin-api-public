...
Examples:
  \`/book approve likenft1abc123\` - Approve for listing & ads (default)
  \`/book approve likenft1abc123 approve_with_ads\` - Approve for listing & ads
  \`/book approve likenft1abc123 approve_no_ads\` - Approve for listing (no ads)
  \`/book approve likenft1abc123 reject\` - Reject/hide listing`,
          });
          break;
        }
        default:
