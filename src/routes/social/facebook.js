...
router.get('/link/facebook/:user', jwtAuth('read'), async (req, res, next) => {
  try {
...
router.post('/link/facebook', jwtAuth('write'), async (req, res, next) => {
  try {
    const {
...
router.post('/link/facebook/:pageId', jwtAuth('write'), async (req, res, next) => {
  try {
